...
func (pr *DefaultPortableReader)RawDataInput() {

	pos := pr.offset + int32(pr.classDefinition.FieldCount()*bufutil.Int32SizeInBytes)
	pr.input.(*ObjectDataInput).ReadInt32WithPosition(pos)
	pr.input.SetPosition(pos)
}
